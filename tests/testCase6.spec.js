...
test.describe('Test Case 6: Verify "App icon design"', () => {
  let appUrl;
  let email;
  let password;
  let boardName;
  ...
  test.beforeAll(() => {
    ...
    const scenario = data.testScenarios['case6'];
  ...
  test('Should login, navigate, and verify task & tags for case6', async ({ page }) => {
    Logger.info('Starting Test Case 6...');
    try {
      ...
      Logger.error(`Test Case 6 FAILED: ${error.message}`);
      throw error;
    }
  });
});
